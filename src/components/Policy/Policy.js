            ...
            <div className="container">
                ...
                <div className="wrapper-policy">
                        <div className="policy-item">
                            <p className="policy-item-num">政策一</p>
                            <p className="policy-item-title">為毛孩子謀福利！推動寵物醫療保障方案</p> 
                        ...
                        <div className="policy-item">
                            <p className="policy-item-num">政策二</p>
                            <p className="policy-item-title">打造休閒天堂！推廣寵物休閒與娛樂場所</p> 
                            <ul className="policy-item-list">
                        ...
                        <div className="policy-item">
                            <p className="policy-item-num">政策三</p>
                            <p className="policy-item-title">推廣寵物飼養教育，讓愛更加專業</p> 
                            <ul className="policy-item-list">
